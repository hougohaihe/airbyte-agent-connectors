...
class ReportIndustryStats(BaseModel):
    ...
    type_: Union[str | None, Any] = Field(default=None, alias="type", description="The type of business industry associated with your account")
...
class EmailActivityActivityItem(BaseModel):
    ...
    type_: Union[str | None, Any] = Field(default=None, alias="type", description="If the action is a bounce, the type of bounce received hard, soft, or blocked")
