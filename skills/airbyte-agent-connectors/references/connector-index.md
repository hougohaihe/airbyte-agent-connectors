...
|------|---------|------|--------------|--------|
| [Airtable](connectors/airtable.md) | `airbyte-agent-airtable` | Token | Bases, Tables, Records | complete |
| [Amazon Ads](connectors/amazon-ads.md) | `airbyte-agent-amazon-ads` | OAuth | Profiles, Portfolios, Sponsored Product Campaigns | complete |
| [Amazon Seller Partner](connectors/amazon-seller-partner.md) | `airbyte-agent-amazon-seller-partner` | OAuth | Orders, Order Items, List Financial Event Groups, List Fi... | complete |
| [Amplitude](connectors/amplitude.md) | `airbyte-agent-amplitude` | Token | Annotations, Cohorts, Events List, Active Users, Average ... | complete |
...
| [Google Analytics Data API](connectors/google-analytics-data-api.md) | `airbyte-agent-google-analytics-data-api` | OAuth | Website Overview, Daily Active Users, Weekly Active Users... | complete |
| [Google Drive](connectors/google-drive.md) | `airbyte-agent-google-drive` | OAuth | Files, Files Upload, Files Export, Drives, Permissions, C... | complete |
| [Google Search Console](connectors/google-search-console.md) | `airbyte-agent-google-search-console` | OAuth | Sites, Sitemaps, Search Analytics By Date, Search Analyti... | complete |
...
| [Snapchat Marketing](connectors/snapchat-marketing.md) | `airbyte-agent-snapchat-marketing` | Token | Organizations, Adaccounts, Campaigns, Adsquads, Ads, Crea... | complete |
| [Stripe](connectors/stripe.md) | `airbyte-agent-stripe` | Token | Customers, Invoices, Charges, Subscriptions, Refunds, Pro... | complete |
